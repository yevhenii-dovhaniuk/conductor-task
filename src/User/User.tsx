...
export class User extends React.Component<UserProps, UserState> {
    ...
    private renderRepositories() {
        ...
        return (
            <div className="user__repositories-container">
                {map(repositories, (node: RepositoryInfo) => (
                    <div
                        className="user__repository"
                        key={node.id}
                        onClick={partial(this.selectRepo, node.name)}
                    >
    ...
    private renderStarred() {
        ...
        return (
            <div className="user__starred-container">
        ...
        return (
            <div className="user">
                ...
                <div className="tile user__stars">
                    <div className="tile__header">Recently Starred repos</div>
                    {this.renderStarred()}
                </div>
            </div>
        );
